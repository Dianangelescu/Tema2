...
plot(r,f),grid;
%Pe baza informatiilor din curs despre seriile Fourier, am folosit sume infinite de sinusuri si
...
%In concluzie, am reconstruit semnalul cu ajutorul formulelor de la Semnale si Sisteme.
